...
<head>
    ...
    <link rel="stylesheet" href="../../css/estiloTP2.css">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="../../js/validacion_tp2_ej2.js"></script>
    <style>
        .error {
            color: red;
            font-size: 14px;
...
<body>
    <div class="container">
        ...
        <div class="card">
            <h2>Formulario ejercicio 6 validado con jquery</h2>
            <form id="miFormulario" action="action.php" method="get">
